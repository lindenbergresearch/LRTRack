...
SOURCES += $(wildcard src/modules/AlmaFilter.cpp src/modules/MS20Filter.cpp src/modules/Westcoast.cpp src/modules/QuickMix.cpp src/modules/VULevelMeter.cpp)
